...
// Placeholders filled in by Server.describe().
...
<root xmlns="urn:schemas-upnp-org:device-1-0" xmlns:dlna="urn:schemas-dlna-org:device-1-0">
  ...
  <device>
    ...
    <manufacturer>nanoDLNA</manufacturer>
    <modelDescription>Lightweight DLNA/UPnP AV media server with external subtitle support</modelDescription>
    <modelName>nanoDLNA</modelName>
...
// fillDescription substitutes the {{placeholder}} markers in a description
// document.
func fillDescription(tmpl string, values map[string]string) string {
